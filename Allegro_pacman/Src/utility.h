...
typedef struct High_score_table {
	int row_num;
	Score_record records[10];
...
void draw_high_score_table(const High_score_table*);
void store_score_records(const char* filepath, const High_score_table*);
