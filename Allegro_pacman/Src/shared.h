...
extern int character_type;
extern int game_type;
extern int p1_key_left;
extern int p1_key_right;
extern int p1_key_up;
extern int p1_key_down;
extern int p2_key_left;
extern int p2_key_right;
extern int p2_key_up;
extern int p2_key_down;
extern int fontSize;
